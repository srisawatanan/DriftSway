 ...
 * This file demonstrates how to integrate Driftsway with a web frontend
 */

// For React/Vue/Angular applications
export class DriftswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DriftswayClient(provider, contractAddress);
